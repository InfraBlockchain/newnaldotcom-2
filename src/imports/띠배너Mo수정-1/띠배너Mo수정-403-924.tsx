function Frame1() {
  return (
    <div className="content-stretch flex flex-col font-['Syne:Regular',sans-serif] gap-[8px] items-start leading-none not-italic relative shrink-0 text-black w-full">
      <p className="relative shrink-0 text-[32px] w-full">AI-Native OS Hackathon</p>
      <p className="relative shrink-0 text-[20px] w-full">@STANFORD / May 9-10th</p>
    </div>
  );
}
